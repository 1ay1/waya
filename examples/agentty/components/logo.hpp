...
"animation:logo-pulse 3.6s ease-in-out 2.16s infinite}"
...
"logo-bob 3s ease-in-out infinite var(--bob-delay)}"
...
"@keyframes logo-drop{from{transform:translateY(-1.4em);opacity:0}to{transform:translateY(0);opacity:1}}"
"@keyframes logo-bob{0%{transform:translateY(0)}25%{transform:translateY(-5px)}50%{transform:translateY(0)}"
"75%{transform:translateY(5px)}100%{transform:translateY(0)}}"
"@keyframes logo-pulse{0%,90%,100%{color:var(--logo-mag);filter:drop-shadow(0 0 20px rgba(226,155,224,.4))}"
"94%{color:#fff;filter:drop-shadow(0 0 34px rgba(255,255,255,.85)) drop-shadow(0 0 12px rgba(226,155,224,.7))}"
"97%{color:#f5d0f2;filter:drop-shadow(0 0 26px rgba(226,155,224,.6))}}"
