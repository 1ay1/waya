...
inline void install_theme() {
    ...
    assets().css(
        ":root{"
        "--bg:#0b0e14;--bg-soft:#12161f;--bg-elev:#1a1f2b;--bg-card:#131822;"
        "--border:#242b38;--border-soft:#1b212c;"
        "--text:#e9eef5;--text-dim:#9aa5b5;--text-faint:#6b7686;"
        "--accent:#5b9dff;--accent-hover:#82b6ff;--accent-2:#c99bff;--accent-warm:#d29922;"
        "--on-accent:#0b0e14;--green:#3fb950;--red:#f85149;--yellow:#d29922;"
        "--code-bg:#080b11;--radius:14px;"
        "--hero-glow-1:rgba(91,157,255,0.13);--hero-glow-2:rgba(201,155,255,0.08);"
        "--nav-bg:rgba(11,14,20,0.72);--matrix-fade:rgba(11,14,20,0.10);"
